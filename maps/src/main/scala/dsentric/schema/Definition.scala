...
object Definition {
  ...
  private def resolveDataOperators[D <: DObject](property:Property[D, _], typeDef:TypeDefinition):TypeDefinition =
    property._dataOperators.foldLeft[TypeDefinition](typeDef)((a, d) => d.definition.lift(a).getOrElse(a))
