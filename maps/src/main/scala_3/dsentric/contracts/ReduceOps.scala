...
private[contracts] trait ReduceOps {
  ...
  protected def reduceProduct[D <: DObject, T, E <: Tuple, H <: Tuple](
    contract: ContractLike[D],
    path: Path,
    badTypes: BadTypes,
  ...
  protected def reduceParameterisedContract[D <: DObject, D2 <: DObject](
    contract: ContractLike[D],
    path: Path,
    badTypes: BadTypes,
  ...
  protected def reduceCoproduct[D <: DObject, T, H <: Tuple](
    contract: ContractLike[D],
    path: Path,
    badTypes: BadTypes,
