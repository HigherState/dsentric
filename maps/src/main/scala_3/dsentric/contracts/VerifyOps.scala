...
private[dsentric] trait VerifyOps {
  ...
  protected def verifyParameterisedContract[D <: DObject, D2 <: DObject](
    contract: ContractLike[D],
    path: Path,
  ...
  protected def verifyProduct[D <: DObject, T, E <: Tuple, H <: Tuple](
    contract: ContractLike[D],
    path: Path,
  ...
  protected def verifyCoproduct[D <: DObject, T, H <: Tuple](
    contract: ContractLike[D],
    path: Path,
